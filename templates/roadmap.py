...
ЭТАПЫ = [
    ("Пилот: 30 заявок через новый конвейер", 0, 3,
     "трудоёмкость ≤ 40 ч/заявка — идём дальше"),
    ("Полный поток типовых заявок", 3, 3,
     "доля заявок в новом процессе ≥ 60 %"),
    ("Интеграции и регламент в проме", 6, 3,
     "трудоёмкость ≤ 34 ч на квартальной выборке"),
    ("Эффект подтверждён, решение о тираже", 9, 3,
